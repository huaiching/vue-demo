...
// ========================================
// 顯示插件：負責將 TTT 轉換為民國年顯示
// ========================================
const minguoFormat = (option: any, dayjsClass: any) => {
...
// ========================================
const minguoParse = (option: any, dayjsClass: any) => {
  const prototype = dayjsClass.prototype
...
export function setupMinguoDayjs() {
  ...
  // 套用插件
  dayjs.extend(minguoFormat)      // 顯示民國年
  dayjs.extend(minguoParse)       // 解析民國年輸入
